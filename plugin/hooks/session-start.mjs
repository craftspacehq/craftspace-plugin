...
process.stdout.write(
  [
    ...
    '   process, tools), search_pages / list_pages, then read_page / read_skill for the detail. Don’t',
    ...
    '   upsert_skill for a reusable procedure, and upsert_decision for any hard-to-reverse call',
